...
// om een array te maken met daarin alle tv-type namen. Log de uitkomst in de console.
...
// Opdracht 1b: Gebruik een array-methode om alle informatie te verzamelen
// van de tv's die volledig uitverkocht zijn. Log de uitkomst in de console.
...
const tvFinder = inventory.find((tv) => {
        return tv.type === 'NH3216SMART';
});

console.log(tvFinder);

// Opdracht 1d: Gebruik een array-methode om een lijst te maken van de merk- en tv-namen waarbij
// aangegeven wordt of deze geschikt zijn voor sport-kijkers (een verversingssnelheid van 100Hz of hoger).
//
...
// Gebruik array-methoden om alle informatie te verzamelen van de tvs die beschikbaar zijn in schermgroottes van 65 inch en groter.


//Opdracht 1f (uitdaging):
// Gebruik array-methoden om alle informatie te verzamelen van de tv's die
// over ambilight beschikken. Log de uitkomst in de console.